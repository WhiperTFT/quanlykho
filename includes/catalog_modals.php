            ...
            <form id="productForm" enctype="multipart/form-data" novalidate> <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                             ...
                             <input class="form-control" type="file" id="productImages" name="product_images[]" multiple accept="image/jpeg,image/png,image/gif" data-max-files="3">
                        ...
                        <div class="col-md-6 mb-3">
                             ...
                             <input class="form-control" type="file" id="productDocuments" name="product_documents[]" multiple accept="application/pdf" data-max-files="3">
