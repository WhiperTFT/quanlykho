    ...
    <table class="table table-hover table-striped table-sm" id="item-details-table">
        ...
        <tfoot>
            <tr class="item-row-template align-middle" style="display: none;">
                 ...
                 <td>
                      <input type="number" class="form-control form-control-sm quantity text-end" name="items[999][quantity]" value="1" min="0" step="any" required>
                      <div class="invalid-feedback"></div>
                 </td>
                  <td>
                      <div class="input-group input-group-sm">
                          <input type="number" class="form-control form-control-sm unit-price text-end" name="items[999][unit_price]" value="0" min="0" step="any" required>
