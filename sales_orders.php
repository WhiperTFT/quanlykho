<?php
// File: sales_orders.php (Đã cập nhật để tích hợp PDF vào nút Lưu)
...
<script>
    ...
    window.APP_CONTEXT = {
        ...
        // mainTableId: '#sales-orders-table',
        // formId: '#order-form',
        // createButtonId: '#btn-create-new-order',
        // ajaxHandler: AJAX_URL.sales_order // (AJAX_URL.sales_order đã được định nghĩa ở trên)
    };
